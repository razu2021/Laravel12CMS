...
// ট্যাগ ম্যানেজমেন্টের জন্য রিঅ্যাক্টিভ ভ্যারিয়েবল
const skillInput = ref('');
const tagInput = ref('');

// স্কিল অ্যাড করার ফাংশন
const addSkill = () => {
    const value = skillInput.value.trim();
    if (value && !form.skills.includes(value)) {
        form.skills.push(value); // Badge হিসেবে যুক্ত হবে
        skillInput.value = '';   // ইনপুট খালি হবে
    }
};
          ...
          <div class="rounded-2xl bg-white p-6 shadow-[0_10px_30px_rgba(0,0,0,0.06)] space-y-6">
                ...
                <div class="grid grid-cols-12 gap-4">
                  <div class="col-span-12 md:col-span-6">
                    <div>
                      ...
                      <input type="text" placeholder="Title" v-model="form.name"
            ...
            <div class="flex flex-wrap gap-2 p-2 border rounded-md focus-within:ring-2 ring-blue-500">
                ...
                <input 
                    ...
                    class="flex-1 outline-none min-w-[150px] text-sm"
                />
            </div>
        </div>
