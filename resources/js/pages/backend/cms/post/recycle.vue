...
<template>
  ...
  <AdminLayout>
      ...
      <div> <Link :href="route('post.all')" class="bg-white hover:bg-gray-100  text-dark px-4 py-2 rounded shadow-lg flex items-center gap-2 w-full sm:w-auto sm:text-center"> <InfoIcon class="text-green-600"/> View Information </Link> </div>
      </div>
              ...
              <DropdownMenu>
                  ...
                  <DropdownMenuContent>
                    <DropdownMenuGroup>
                      ...
                      <!-- end -->
                      <DropdownMenuItem>
                        <button @click="confirmDelete('post.delete',data.id)" class="w-full inline-flex items-center gap-2  text-sm font-medium text-red-300 rounded-lg">
