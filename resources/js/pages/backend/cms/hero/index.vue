...
const {form} = useFilter(props,'hero.all')
      ...
      <div>
        <DropdownMenu>
          ...
          <DropdownMenuContent>
            <DropdownMenuGroup>
              <DropdownMenuItem>
                <a :href=" route('hero.export_pdf') " target="_blank" class="w-full inline-flex items-center gap-2  text-sm font-medium text-yellow-600 rounded-lg">
              ...
              <!-- end -->
              <DropdownMenuItem>
                <a :href=" route('hero.export_pdf') " target="_blank" class="w-full inline-flex items-center gap-2  text-sm font-medium text-green-600 rounded-lg">
                  <span class="flex items-center"><Download /></span>
              ...
              <!-- end -->
              <DropdownMenuItem>
                <a :href="route('hero.export_pdf')" target="_blank" class="w-full inline-flex items-center gap-2  text-sm font-medium text-blue-600 rounded-lg">
                  <span class="flex items-center"><Download /></span>
              ...
              <DropdownMenu>
                  ...
                  <DropdownMenuContent>
                    <DropdownMenuGroup>
                      ...
                      <!-- end -->
                      <DropdownMenuItem>
                        <Link :href="route('hero.view',{id:data.id , slug:data.slug})" class="w-full inline-flex items-center gap-2  text-sm font-medium text-gray-600 rounded-lg">
                      ...
                      <!-- end -->
                      <DropdownMenuItem>
                        <button @click="confirmDelete('hero.softdelete',data.id)" class="w-full inline-flex items-center gap-2  text-sm font-medium text-red-300 rounded-lg">
                    ...
                    <DropdownMenuGroup>
                      ...
                      <DropdownMenuItem>
                        <Link :href="route('hero.active',{id:data.id , slug:data.slug})" class="w-full inline-flex items-center gap-2  text-sm font-medium text-green-600 rounded-lg">
                      ...
                      <!-- end -->
                      <DropdownMenuItem>
                        <Link :href="route('hero.deactive',{id:data.id , slug:data.slug})" class="w-full inline-flex items-center gap-2  text-sm font-medium text-yellow-600 rounded-lg">
                      ...
                      <!-- end -->
                       <DropdownMenuSeparator />
                        <!-- end -->
                      <DropdownMenuItem>
                        <a target="_blank" :href="route('hero.single_pdf_export',{id:data.id , slug:data.slug})" class="w-full inline-flex items-center gap-2  text-sm font-medium text-cyan-600 rounded-lg">
