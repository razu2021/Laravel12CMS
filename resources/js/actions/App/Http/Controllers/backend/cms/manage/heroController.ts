...
const heroController = { index, add, view, edit, insert, update, active, deactive, softdelete, deleteMethod, recycle, bulkAction, exportPdf, export_excel, export_csv, export_pdf, getCategory, getSubcategory, getChildcategory, delete: deleteMethod }
